                    ...
                    {paginated.map((img, index) => (
                        <AnimatedSection key={img.srcImg} delay={index * 0.03}>
                            <div className="group overflow-hidden rounded-2xl shadow-lg hover:shadow-2xl transition cursor-pointer bg-card border border-border">
                                <div className="relative w-full h-56 overflow-hidden rounded-2xl cursor-pointer"
                                    onClick={() =>
                                        setSelectedImg({ src: img.srcImg, alt: img.alt })
                                    }>
                                    <Image
                                        src={img.srcImg}
                                        alt={img.alt}
                                        ...
                                        fetchPriority={index === 0 && page === 1 ? "high" : "auto"}
                                        decoding="async"
